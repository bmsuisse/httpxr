...
def test_client_base_url():
    ...
    assert isinstance(client.base_url, httpr.URL)
...
def test_client_headers():
    client = httpr.Client()
    client.headers = {"a": "b"}
    assert isinstance(client.headers, httpr.Headers)
...
def test_client_cookies():
    client = httpr.Client()
    client.cookies = {"a": "b"}
    assert isinstance(client.cookies, httpr.Cookies)
...
def test_client_timeout():
    ...
    assert isinstance(client.timeout, httpr.Timeout)
...
def test_client_trust_env():
    ...
    client = httpr.Client(trust_env=False)
